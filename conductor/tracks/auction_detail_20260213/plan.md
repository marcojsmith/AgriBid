...
- [ ] Task: Install `react-router-dom` and set up basic routing.
    - [ ] Create a `pages/` directory.
    - [ ] Implement a placeholder `AuctionDetail` page.
    - [ ] Configure routes in `App.tsx` for `/` and `/auction/:id`.
- [ ] Task: Implement the "Above-the-Fold" layout structure.
...
- [ ] Task: Implement Bid Submission Form.
    - [ ] Write tests for bid validation logic (manual input $\ge$ increment).
...
- [ ] Task: Refine Mobile Responsiveness.
    - [ ] Ensure touch targets for bidding buttons are $\ge$ 44x44px.
