...
| --- | ------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1   | [#233](https://github.com/marcojsmith/AgriBid/issues/233) — seller-filtered auction listing page | **Done — [PR #258](https://github.com/marcojsmith/AgriBid/pull/258)** (open, awaiting review; CodeRabbit review triggered) | Dead "View all" links on a page already in active use                                                                                                                                                                                                                                                |
