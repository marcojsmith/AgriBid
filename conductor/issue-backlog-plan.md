...
(PR #260) → `feat/issue-232-report-profile` (PR #261) → next issue's branch → ... Each
...
`feat/issue-232-report-profile`** — the next issue branches from there.
...
| 4   | [#231](https://github.com/marcojsmith/AgriBid/issues/231) — seller messaging/contact system      | In progress — feat/issue-231-seller-messaging                                                                                                                            | Larger (new `conversations`/`messages` tables + real-time UI) — do after the two smaller trust-focused issues                                                                                                                                                                                        |
