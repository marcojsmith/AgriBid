...
| 12  | [#269](https://github.com/marcojsmith/AgriBid/issues/269) — brand theming settings (font/colors/logo/radius) | Backlog, deliberately not started (2026-09-09)                                                                                                                          | Single-brand marketplace today, not multi-tenant/white-label — a settings UI is premature and would reintroduce the inconsistency the visual refresh is fixing. See issue for full context/future shape. Only pick up if a white-label need shows up.                                                |
