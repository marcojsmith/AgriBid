...
export const updateMyPreferences = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    if (
      args.defaultMinYear !== undefined &&
      args.defaultMaxYear !== undefined &&
      args.defaultMinYear > args.defaultMaxYear
    ) {
      throw new Error("defaultMinYear cannot be greater than defaultMaxYear");
    }

    if (
      args.defaultMinPrice !== undefined &&
      args.defaultMaxPrice !== undefined &&
      args.defaultMinPrice > args.defaultMaxPrice
    ) {
