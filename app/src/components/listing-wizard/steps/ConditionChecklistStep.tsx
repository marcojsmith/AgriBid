  ...
  const checklistItems = [
    {
      ...
      desc: "Is the engine running smoothly without leaks?",
    },
    {
      id: "hydraulics" as const,
      label: "Hydraulic System",
      desc: "Are all hydraulic cylinders and hoses in good working order?",
    },
    {
      id: "tires" as const,
      label: "Tires / Tracks",
      desc: "Do tires/tracks have more than 50% tread remaining?",
    },
    {
      id: "serviceHistory" as const,
      label: "Service History",
      desc: "Do you have complete maintenance records for this unit?",
    },
  ];
        ...
        {checklistItems.map((item) => (
          ...
          >
            ...
            <div className="flex gap-2">
              <Button
                variant={
                  formData.conditionChecklist[item.id] === true
                    ? "default"
                    : "outline"
                }
                size="sm"
              ...
              <Button
                variant={
                  formData.conditionChecklist[item.id] === false
                    ? "destructive"
                    : "outline"
                }
                size="sm"
