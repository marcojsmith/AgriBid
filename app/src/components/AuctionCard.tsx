...
export const AuctionCard = ({ auction }: AuctionCardProps) => {
  ...
  return (
    <Card className="overflow-hidden border-2 hover:border-primary transition-colors bg-card">
      ...
      <CardHeader className="p-4 pb-2">
        <CardTitle className="text-lg leading-tight font-bold">{auction.title}</CardTitle>
