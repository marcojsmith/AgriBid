...
/**
 * UI for managing equipment metadata and categories via tabbed views and a search field.
 *
 * @returns The rendered equipment metadata editor interface containing the catalog and categories management views
 */
