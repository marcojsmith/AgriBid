...
export default function Login() {
  ...
  return (
    <div
      id="auth-form"
      className="max-w-md mx-auto mt-12 mb-20 space-y-8 border-2 border-primary/20 p-8 rounded-2xl bg-card shadow-xl animate-in fade-in slide-in-from-bottom-4 duration-500"
    >
      <div className="text-center">
        ...
        <p className="text-muted-foreground text-sm uppercase tracking-widest">
          {authMode === "signin"
            ...
            : "Join the Leading Agricultural Marketplace"}
        </p>
      </div>
      ...
      >
        ...
        <div className="space-y-2">
          <label
            htmlFor="email"
            className="text-xs font-black uppercase text-muted-foreground ml-1 tracking-wider"
          >
            Email Address
          </label>
          <Input
        ...
        <Button
          type="submit"
          className="h-14 text-lg font-black uppercase tracking-tight rounded-xl shadow-lg shadow-primary/20 mt-2"
