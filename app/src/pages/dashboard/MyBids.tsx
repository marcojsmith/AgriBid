...
/**
 * Map an auction's status and flags to a user-facing badge configuration.
 *
 * @param auction - The auction whose display status is required
 * @returns A StatusDisplay containing the badge `label`, visual `variant`, `icon`, and `colorClass` for styling
 */
...
/**
 * Render the "My Bids" dashboard showing the user's bids, with filtering, sorting, stats and pagination.
 *
 * Renders summary cards when bids exist, a grid of auction cards (including status badges, countdowns,
 * bid summaries and contextual action buttons), controls for filter and sort, and appropriate empty or loading states.
 *
 * @returns The My Bids page as a JSX element
 */
