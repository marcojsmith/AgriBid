...
/**
 * Compute aggregated bid metrics for a user and per-auction bid summaries.
 *
 * @param ctx - Query context used to read bids and auctions
 * @param userId - ID of the user to calculate stats for
 * @returns An object containing:
 *  - `globalStats`: totals for the user with fields `totalActive`, `winningCount`, `outbidCount`, and `totalExposure`
 *  - `auctionStatsMap`: a Map keyed by auction ID whose values are objects with `lastBidTimestamp`, `highestBid`, and `bidCount`
 */
