/**
 * PII encryption and decryption utilities using AES-256-GCM.
 *
 * Provides secure encryption/decryption for sensitive personal information
 * using the Web Crypto API with AES-GCM. Compatible with Convex standard runtime.
 */
