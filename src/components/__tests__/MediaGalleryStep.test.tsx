...
import { MediaGalleryStep } from "../listing-wizard/steps/MediaGalleryStep";
import { useListingWizard } from "../listing-wizard/hooks/useListingWizard";
import { useListingMedia } from "../listing-wizard/hooks/useListingMedia";
...
vi.mock("../listing-wizard/hooks/useListingMedia", () => ({
