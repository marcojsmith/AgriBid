 ...
 * @param root0.className - Optional additional CSS classes merged with the input's default styles.
 * @param root0.type - The HTML input type attribute (e.g., `"text"`, `"file"`, `"password"`).
