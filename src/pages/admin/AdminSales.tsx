// app/src/pages/admin/AdminSales.tsx
...
import { AuctionEventFormDialog } from "./sales/AuctionEventFormDialog";
 ...
 * assignment screen.
 *
 * @returns The AdminSales page component.
 */
export default function AdminSales() {
  const auctionEvents = useQuery(api.auctions.getAllAuctionEvents);
  ...
  if (auctionEvents === undefined) {
    return (
      <AdminLayout title="Auction Events" subtitle="Manage Scheduled Sales">
